        ...
        public bool Initialize()
        {
            ...
            try
            {
                ...
                if ((m_request = m_manager.RequestCreate()) == null)
                {
                    ...
                    MessageBox.Show("经销商：创建请求对象失败", "错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return (false);
                }
                //--- 创建确认对象
                if ((m_confirm = m_manager.DealerConfirmCreate()) == null)
                {
                    ...
                    MessageBox.Show("经销商：创建确认对象失败", "错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return (false);
                }
                //--- 创建请求事件
                ...
                if ((res = m_request_sink.Initialize(m_manager, m_event_request)) != MTRetCode.MT_RET_OK)
                {
                    ...
                    MessageBox.Show("经销商：创建请求接收器失败", "错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return (false);
                }
                ...
                if ((res = m_user_sink.Initialize(m_manager)) != MTRetCode.MT_RET_OK)
                {
                    ...
                    MessageBox.Show("用户：创建请求接收器失败", "错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return (false);
                }
                ...
                if ((res = m_order_sink.Initialize(m_manager)) != MTRetCode.MT_RET_OK)
                {
                    ...
                    MessageBox.Show("订单：创建请求接收器失败", "错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return (false);
                }
                //----
                ...
                if ((res = m_Position_sink.Initialize(m_manager, PositionAddCallBack, PositionDelCallBack, PositionUpateCallBack)) != MTRetCode.MT_RET_OK)
                {
                    ...
                    MessageBox.Show("持仓：创建请求接收器失败", "错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return (false);
                }
